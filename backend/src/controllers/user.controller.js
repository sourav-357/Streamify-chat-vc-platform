...
export async function removeFriend(req, res) {
  try {
    ...
    // pull friend from each other's list
...
// cancel a pending friend request (sender only)
...
// simple search for users by name (used in friend-search UI)
...
// fetch basic profile information for a given user id
